		...
		<div class="container-fluid">
		    <div class="centered col-*-4 border" id="admlogin">
					...
					<form name="loginform" method="post" action="admLoginPro.jk?pgadr=main.jk" onsubmit="return logincheck()">
						...
						<input class="btn btn-primary" type="button" value="${btn_join}"
							onclick="location='admInputForm.jk'">
						<input class="btn btn-primary" type="button" value="${btn_findPw}"
							onclick="location='admFindPasswd()'">
					</form>
			 </div>
		</div>
	</body>
